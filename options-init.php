...
if (!class_exists('business_review_Redux_Framework_config')) {

    class business_review_Redux_Framework_config {
...
//                        )
        ...
        public function setArguments() {
            ...
            $this->args = array(
                ...
                'display_name' => 'Business Reviews Settings',
                'display_version' => 'Business Reviews',
                'page_slug' => 'business_reviews_options',
                'page_title' => 'Business Reviews Settings',
                'update_notice' => true,
                'menu_type' => 'submenu',
                'menu_title' => 'Configure',
                'allow_sub_menu' => true,
                'page_parent' => 'edit.php?post_type=',
    ...
    global $reduxConfig;
    $reduxConfig = new business_review_Redux_Framework_config();
}

/**
  Custom function for the callback referenced above
 */
if (!function_exists('business_review_my_custom_field')):
    function business_review_my_custom_field($field, $value) {
        print_r($field);
        echo '<br/>';
        print_r($value);
    }
 ...
 * */
if (!function_exists('business_review_validate_callback_function')):
    function business_review_validate_callback_function($field, $value, $existing_value) {
        $error = false;
        $value = 'just testing';
